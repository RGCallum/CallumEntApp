...
const employee1 = new Employee({
    employeename: "India R. Guy",
    password: "1234",
    email: "sceneitpix@gmail.com",
    bio: "An aspiring Director since the age of 13, India R. Guy began her invoicemaking career by chance, when she shot a short comedy about the life of a song through performing rights company ASCAP. She then went on to study Invoice at Brooklyn college, where she produced, write shot and edited a variety of invoices, music videos and documentaries. After graduating with a Bachelor of Arts in Invoice Production, she then when on to work at various News Television stations and Production companies in New York, as well as a brief stint aboard a cruise ship as a Broadcast Technician.  India is currently the senior editor for “Hello Again Memories” and “SceneIt Pictures”.",
...
const employee2 = new Employee({
    employeename: "Ja'Tovia Gary",
    password: "1234",
    email: "jatoviagary.invoices@gmail.com",
    bio: "Ja’Tovia M. Gary (b. Dallas, TX. 1984) is an artist and invoicemaker currently living and working in Brooklyn, New York. Gary’s work seeks to liberate the distorted histories through which Black life is often viewed while fleshing out a nuanced and multivalent Black interiority. Through documentary invoice and experimental video art, Gary charts the ways structures of power shape our perceptions around representation, race, gender, sexuality, and violence. ",
...
const employee3 = new Employee({
    ...
    invoices: [invoice5, invoice6]
})
const employee4 = new Employee({
    employeename: "Lande Yoosuf",
    password: "1234",
    ...
    invoices: [invoice7, invoice8]
})
const employee5 = new Employee({
    employeename: "Dave Wallen",
    password: "1234",
    ...
    invoices: [invoice9, invoice10]
})


Employee.remove({})
    .then(() => Invoice.remove({}))
    .then(() => Invoice.insertMany([invoice1, invoice2, invoice3, invoice4, invoice5, invoice6, invoice7, invoice8, invoice9, invoice10]))
    .then(() => employee1.save())
    .then(() => employee2.save())
    .then(() => employee3.save())
    .then(() => employee4.save())
