...
*/}
    ...
    /> */}
                                        ...
                                        <div className="memo noprint"> <b>Memo:</b>  <br />
                                            ...
                                            {/* {this.state.employee.employeename} serviced {this.state.invoice.client2} for {this.state.invoice.frequency2} {this.state.invoice.result2}s at a rate of {"$" + this.state.invoice.rate2} per {this.state.invoice.result2} = <b> {"$" + (this.state.invoice.rate2 * this.state.invoice.frequency2).toFixed(2)} </b> */}
